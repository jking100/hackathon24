...
# Load CSV files
csv1_path = 'monarch_data/monarch_data_all.csv'
csv2_path = 'monarch_data/updated_unique_towns_us_with_counties.csv'

csv1 = pd.read_csv(csv1_path)  # Load CSV1 (with Date, Town, State/Province, etc.)
csv2 = pd.read_csv(csv2_path)  # Load CSV2 (with Town, State, County)
...
csv1_filtered['Town_lower'] = csv1_filtered['Town'].str.lower()
csv1_filtered['State_lower'] = csv1_filtered['State/Province'].str.lower()

csv2['Town_lower'] = csv2['Town'].str.lower()
csv2['State_lower'] = csv2['State'].str.lower()

# Merge csv1 and csv2 based on Town and State/Province
merged_df = pd.merge(csv1_filtered, csv2[['Town_lower', 'State_lower', 'County']], how='left', 
...
merged_df.to_csv('monarch_data/monarch_data_all_with_counties.csv', index=False)

print("Filtered CSV1 with county information saved as 'monarch_data_all_with_counties.csv'")
